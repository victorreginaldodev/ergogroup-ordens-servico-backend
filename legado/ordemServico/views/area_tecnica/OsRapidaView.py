...
from legado.ordemServico.forms import OsRapidaFullUpdateForm
from legado.ordemServico.forms import OsRapidaForm, OsRapidaUpdateForm
from legado.ordemServico.models import MiniOS, Profile
