...
from legado.ordemServico.forms import OsRapidaFaturamentoForm
from legado.ordemServico.models import OrdemServico, Profile, MiniOS, Servico
from legado.ordemServico.forms import OrdemServicoUpdateForm
