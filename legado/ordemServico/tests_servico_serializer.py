...
from legado.ordemServico.models import Servico, Cliente, Profile, Repositorio, OrdemServico
from legado.ordemServico.serializers.ServicoSerializer import ServicoListSerializer
